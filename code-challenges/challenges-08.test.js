...
const typeNum = (arr) => {
  // Solution code here...
  const arrayNumber = arr.filter(element =>{
...
const containsAnd = (arr) => {
  // Solution code here...
  const arrayAnd=arr.filter(element=>{
...
const filterStringsWithVowels = (arr) => {
  ...
  const arrayVowels=arr.filter(element=>{
    return element.match(regVowels);
  })
  return arrayVowels;
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  const notInArray=arr.filter(element=>{
